...
pizza_ingredients_data_unique.to_sql(
    "pizzaingredients", con=engine, if_exists="append", index=False
)
pizza_data_unique.to_sql("pizza", con=engine, if_exists="append", index=False)
order_details_data.to_sql("orderdetails", con=engine, if_exists="append", index=False)
